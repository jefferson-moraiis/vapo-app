...
import { PhoneMaskCustom, TelephoneMaskCustom } from 'src/components/mask';
...
export default function UserPage() {
  ...
  useEffect(() => {
    if (cepData) {
      ...
      // Sete outros valores conforme necessário
    }
          ...
          <Dialog open={open} onClose={handleClose} fullScreen maxWidth="xl">
            <DialogContent>
              <Toolbar>
                <Typography
                  sx={{
                    flexGrow: 1, // Isso faz com que o Typography cresça e ocupe o espaço disponível
                    display: 'flex',
                    justifyContent: 'center', // Centraliza o conteúdo de Typography
                  }}
                  variant="h3"
                  component="div"
                >
